# RailsAdmin config file. Generated on May 08, 2013 18:26
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Quote8', 'Admin']
  ...
  # config.excluded_models = ['Bookmark', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Bookmark', 'User']
